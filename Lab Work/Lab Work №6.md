...
tar створює архіви з файлів і директорій та розпаковує їх, опціонально з стисненням

xz стискає файли з високим ступенем стиснення, створюючи файли з розширенням .xz

zip створює архіви у форматі ZIP, зберігаючи структуру каталогів

bzip2 стискає файли з високим ступенем стиснення, створюючи .bz2 файли

gzip стискає окремі файли, створюючи .gz файли та замінює оригінал
